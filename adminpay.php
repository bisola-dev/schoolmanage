...
$quer = mysqli_query($conn, "SELECT * FROM payment");
                           ...
                           <div class="table-responsive">
                              <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                 ...
                                 <tbody>
                                    ...
                                    $quer10 = mysqli_query($conn, "SELECT * FROM applicants WHERE emal = '$email'");

                                  while ($row=mysqli_fetch_assoc($quer10)) {
                                    $course = $row['course'];
                                    $prog= $row['prog'];
                                    $flask=$course.'   '.$prog;
                                    $count++;
                                    ...
                                    <tr>
                                       ...
                                       <th><?php echo $flask;?></th>
                                       <th><?php echo $datepaid;?></th>
